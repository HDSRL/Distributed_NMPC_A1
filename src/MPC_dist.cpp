...
void MPC_dist::run_NMPC() {
    ...
    // TODO : computePath() replaces copPlanner_eventbase() 
    copPlanner_eventbase(M, Ndomain, N, swingPhase);

    // TODO : Does footholdsPlanner() need to be modified?
    footholdsPlanner();

    double g = 9.81;
    double h = 0.29; // remove

    // TODO : change this accordingly
    double Ts_opt = ts_OptTick_*0.001;

    // TODO : Nonlinear SRB Dynamics come here  
...
void MPC_dist::copPlanner_eventbase(double M, double Ndomain, double N, double swingPhase){
    ...
    // std::cout << "Pr_refined_ = \n" << Pr_refined_ << std::endl;
